...
/**
 * A demonstration application showing a {@link CombinedDomainXYPlot} with two
 * subplots.
 */
...
public class CombinedXYPlotDemo1 extends ApplicationFrame {
	...
	private static JFreeChart createCombinedChart() {
		...
		JFreeChart chart = new JFreeChart("United States Public Debt", JFreeChart.DEFAULT_TITLE_FONT, cplot, false);
		chart.setBackgroundPaint(Color.white);
		TextTitle source = new TextTitle("Source: http://www.publicdebt.treas.gov/opd/opdhisms.htm", new Font("Dialog",
				Font.PLAIN, 10));
	...
	private static IntervalXYDataset createDataset1() {
		...
		// create dataset 1...
		TimeSeries series1 = new TimeSeries("Public Debt Outstanding", Month.class);
	...
	private static IntervalXYDataset createDataset2() {
		...
		TimeSeries series1 = new TimeSeries("Change from previous year", Month.class);
