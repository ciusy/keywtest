...
public class LastDayFinalPricePolicy extends OperatePolicy {
    ...
    public static OperatePolicy getInstance(String fullargs) {
        String[] args=fullargs.split(",");
       return new LastDayFinalPricePolicy(Float.parseFloat(args[0]),Float.parseFloat(args[1]));
    }

  
    public String getFullargs() {
        return this.intrestRate+","+this.lostRate;
    }
}
